...
2.  **Archivo de ejemplo**: Es buena práctica subir un archivo llamado `config.py.example` que sea idéntico al que te pasé arriba pero con el espacio de la clave vacío. Así la gente sabe qué estructura debe tener sin que vos expongas la tuya.
